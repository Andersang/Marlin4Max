...
#define STRING_CONFIG_H_AUTHOR "(AndersAng, default config)" // Who made the changes.
...
#define BUILD_PREFIX "4MAX "  // x.y.zz | Count zz Up for testing Builds.
    ...
    #define BUILD_VERSION "2.1.2.1"    // Version Info - Major.Minor.Build Build - WXYZ
 ...
 * With updates for Bondtech BMG extruder
 */
